...
export const Diff$Diff = (patch, events) => new Diff(patch, events);
...
export const Diff$Diff$events = (value) => value.events;
export const Diff$Diff$1 = (value) => value.events;
      ...
      if (prev.key !== next.key) {
        ...
        if ($ instanceof Fragment) {
          ...
          if ($1 instanceof Element) {
            ...
            let next$1 = $1;
            if (
              (prev$1.namespace === next$1.namespace) && (prev$1.tag === next$1.tag)
            ) {
              let old$1 = old.tail;
              let new$1 = new$.tail;
