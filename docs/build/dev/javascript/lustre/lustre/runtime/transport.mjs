...
export const ClientMessage$Mount = (kind, open_shadow_root, will_adopt_styles, observed_attributes, observed_properties, requested_contexts, provided_contexts, vdom) =>
  new Mount(kind,
  open_shadow_root,
  will_adopt_styles,
  observed_attributes,
...
export const ClientMessage$Reconcile = (kind, patch) =>
  new Reconcile(kind, patch);
