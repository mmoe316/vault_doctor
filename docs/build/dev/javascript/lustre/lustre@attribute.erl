...
-file("src/lustre/attribute.gleam", 501).
?DOC(" Indicates whether the details element is open or closed.\n").
-spec open(boolean()) -> lustre@vdom@vattr:attribute(any()).
open(Is_open) ->
    boolean_attribute(<<"open"/utf8>>, Is_open).

-file("src/lustre/attribute.gleam", 510).
?DOC(
...
-file("src/lustre/attribute.gleam", 528).
?DOC(
...
-file("src/lustre/attribute.gleam", 543).
?DOC(
...
-file("src/lustre/attribute.gleam", 550).
?DOC(
...
-file("src/lustre/attribute.gleam", 557).
?DOC(
...
-file("src/lustre/attribute.gleam", 575).
?DOC(
...
-file("src/lustre/attribute.gleam", 601).
?DOC(
...
-spec as_(binary()) -> lustre@vdom@vattr:attribute(any()).
as_(Value) ->
    attribute(<<"as"/utf8>>, Value).

-file("src/lustre/attribute.gleam", 613).
?DOC(
...
-spec blocking(boolean()) -> lustre@vdom@vattr:attribute(any()).
blocking(Value) ->
    attribute(<<"blocking"/utf8>>, case Value of
            true ->
                <<"render"/utf8>>;
...
-file("src/lustre/attribute.gleam", 627).
?DOC(
...
-spec integrity(binary()) -> lustre@vdom@vattr:attribute(any()).
integrity(Hash) ->
    attribute(<<"integrity"/utf8>>, Hash).
...
-file("src/lustre/attribute.gleam", 643).
...
-file("src/lustre/attribute.gleam", 658).
?DOC(
...
-file("src/lustre/attribute.gleam", 665).
?DOC(
...
-file("src/lustre/attribute.gleam", 671).
...
-file("src/lustre/attribute.gleam", 678).
?DOC(
...
-file("src/lustre/attribute.gleam", 684).
...
-file("src/lustre/attribute.gleam", 690).
...
-file("src/lustre/attribute.gleam", 697).
?DOC(
...
-file("src/lustre/attribute.gleam", 704).
?DOC(
...
-file("src/lustre/attribute.gleam", 711).
?DOC(
...
-file("src/lustre/attribute.gleam", 721).
?DOC(
...
-file("src/lustre/attribute.gleam", 728).
?DOC(
...
-file("src/lustre/attribute.gleam", 741).
?DOC(
...
-file("src/lustre/attribute.gleam", 753).
?DOC(
...
-file("src/lustre/attribute.gleam", 760).
?DOC(
...
-file("src/lustre/attribute.gleam", 785).
?DOC(
...
-file("src/lustre/attribute.gleam", 796).
?DOC(
...
-file("src/lustre/attribute.gleam", 841).
?DOC(
...
-file("src/lustre/attribute.gleam", 855).
?DOC(
...
-file("src/lustre/attribute.gleam", 868).
?DOC(
...
-spec default_checked(boolean()) -> lustre@vdom@vattr:attribute(any()).
default_checked(Is_checked) ->
    boolean_attribute(<<"virtual:defaultChecked"/utf8>>, Is_checked).

-file("src/lustre/attribute.gleam", 887).
?DOC(
...
-file("src/lustre/attribute.gleam", 905).
?DOC(
...
-file("src/lustre/attribute.gleam", 912).
?DOC(
...
-file("src/lustre/attribute.gleam", 918).
?DOC("\n").
-spec for(binary()) -> lustre@vdom@vattr:attribute(any()).
for(Id) ->
    attribute(<<"for"/utf8>>, Id).

-file("src/lustre/attribute.gleam", 924).
...
-file("src/lustre/attribute.gleam", 936).
?DOC(
...
-file("src/lustre/attribute.gleam", 945).
?DOC(
...
-file("src/lustre/attribute.gleam", 963).
?DOC(
...
-file("src/lustre/attribute.gleam", 972).
?DOC(
...
-file("src/lustre/attribute.gleam", 1012).
?DOC(
...
-file("src/lustre/attribute.gleam", 1043).
?DOC(
    " Minimum value\n"
    "\n"
    " The following input types support the `\"max\"` attribute:\n"
...
-file("src/lustre/attribute.gleam", 1056).
?DOC(
...
-file("src/lustre/attribute.gleam", 1067).
?DOC(
...
-file("src/lustre/attribute.gleam", 1086).
?DOC(
...
-file("src/lustre/attribute.gleam", 1100).
?DOC(
...
-file("src/lustre/attribute.gleam", 1113).
?DOC(
...
-file("src/lustre/attribute.gleam", 1126).
?DOC(
...
-file("src/lustre/attribute.gleam", 1146).
?DOC(
...
-file("src/lustre/attribute.gleam", 1168).
?DOC(
...
-file("src/lustre/attribute.gleam", 1176).
?DOC(
...
-file("src/lustre/attribute.gleam", 1190).
?DOC(
...
-spec default_selected(boolean()) -> lustre@vdom@vattr:attribute(any()).
default_selected(Is_selected) ->
    boolean_attribute(<<"virtual:defaultSelected"/utf8>>, Is_selected).

-file("src/lustre/attribute.gleam", 1205).
?DOC(
    " Size of the control\n"
    "\n"
...
-file("src/lustre/attribute.gleam", 1221).
?DOC(
...
-file("src/lustre/attribute.gleam", 1252).
?DOC(
...
-file("src/lustre/attribute.gleam", 1268).
?DOC(
...
-file("src/lustre/attribute.gleam", 1275).
?DOC(
...
-file("src/lustre/attribute.gleam", 1282).
?DOC(
...
-file("src/lustre/attribute.gleam", 1296).
?DOC(
...
-file("src/lustre/attribute.gleam", 1303).
?DOC(
...
-file("src/lustre/attribute.gleam", 1310).
?DOC(
...
-file("src/lustre/attribute.gleam", 1317).
?DOC(
...
-file("src/lustre/attribute.gleam", 1328).
?DOC(
...
-file("src/lustre/attribute.gleam", 1335).
?DOC(
...
-file("src/lustre/attribute.gleam", 1367).
?DOC(
...
-file("src/lustre/attribute.gleam", 1374).
?DOC(
...
-file("src/lustre/attribute.gleam", 1381).
?DOC(
...
-file("src/lustre/attribute.gleam", 1399).
?DOC(
...
-file("src/lustre/attribute.gleam", 1414).
?DOC(
...
-file("src/lustre/attribute.gleam", 1435).
?DOC(
...
-file("src/lustre/attribute.gleam", 1444).
?DOC(
...
-file("src/lustre/attribute.gleam", 1453).
?DOC(
...
-file("src/lustre/attribute.gleam", 1459).
?DOC("\n").
-spec role(binary()) -> lustre@vdom@vattr:attribute(any()).
role(Name) ->
    attribute(<<"role"/utf8>>, Name).

-file("src/lustre/attribute.gleam", 1466).
?DOC(
...
-file("src/lustre/attribute.gleam", 1475).
?DOC(
...
-file("src/lustre/attribute.gleam", 1487).
?DOC(
...
-file("src/lustre/attribute.gleam", 1494).
?DOC(
...
-file("src/lustre/attribute.gleam", 1502).
?DOC(
...
-file("src/lustre/attribute.gleam", 1510).
?DOC(
...
-file("src/lustre/attribute.gleam", 1520).
?DOC(
...
-file("src/lustre/attribute.gleam", 1527).
?DOC(
...
-file("src/lustre/attribute.gleam", 1541).
?DOC(
...
-file("src/lustre/attribute.gleam", 1548).
?DOC(
...
-file("src/lustre/attribute.gleam", 1556).
?DOC(
...
-file("src/lustre/attribute.gleam", 1563).
?DOC(
...
-file("src/lustre/attribute.gleam", 1570).
?DOC(
...
-file("src/lustre/attribute.gleam", 1577).
?DOC(
...
-file("src/lustre/attribute.gleam", 1584).
?DOC(
...
-file("src/lustre/attribute.gleam", 1591).
?DOC(
...
-file("src/lustre/attribute.gleam", 1609).
?DOC(
...
-file("src/lustre/attribute.gleam", 1629).
?DOC(
...
-file("src/lustre/attribute.gleam", 1636).
?DOC(
...
-file("src/lustre/attribute.gleam", 1646).
?DOC(
...
-file("src/lustre/attribute.gleam", 1653).
?DOC(
...
-file("src/lustre/attribute.gleam", 1660).
?DOC(
...
-file("src/lustre/attribute.gleam", 1667).
?DOC(
...
-file("src/lustre/attribute.gleam", 1674).
?DOC(
...
-file("src/lustre/attribute.gleam", 1682).
?DOC(
...
-file("src/lustre/attribute.gleam", 1688).
...
-file("src/lustre/attribute.gleam", 1698).
?DOC(
...
-file("src/lustre/attribute.gleam", 1708).
?DOC(
...
-file("src/lustre/attribute.gleam", 1726).
?DOC(
...
-file("src/lustre/attribute.gleam", 1734).
?DOC(
...
-file("src/lustre/attribute.gleam", 1767).
?DOC(
...
-file("src/lustre/attribute.gleam", 1774).
?DOC(
...
-file("src/lustre/attribute.gleam", 1784).
?DOC(
...
-file("src/lustre/attribute.gleam", 1791).
?DOC(
...
-file("src/lustre/attribute.gleam", 1798).
?DOC(
...
-file("src/lustre/attribute.gleam", 1805).
?DOC(
...
-file("src/lustre/attribute.gleam", 1812).
?DOC(
...
-file("src/lustre/attribute.gleam", 1819).
?DOC(
...
-file("src/lustre/attribute.gleam", 1829).
?DOC(
...
-file("src/lustre/attribute.gleam", 1836).
?DOC(
...
-file("src/lustre/attribute.gleam", 1843).
?DOC(
...
-file("src/lustre/attribute.gleam", 1850).
?DOC(
...
-file("src/lustre/attribute.gleam", 1856).
...
-file("src/lustre/attribute.gleam", 1863).
?DOC(
