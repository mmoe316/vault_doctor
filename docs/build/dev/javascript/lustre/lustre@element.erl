...
-spec element(
    binary(),
    list(lustre@vdom@vattr:attribute(PHC)),
    list(lustre@vdom@vnode:element(PHC))
) -> lustre@vdom@vnode:element(PHC).
...
-spec namespaced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(PHI)),
    list(lustre@vdom@vnode:element(PHI))
) -> lustre@vdom@vnode:element(PHI).
...
-spec advanced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(PHO)),
    list(lustre@vdom@vnode:element(PHO)),
    boolean(),
    boolean()
) -> lustre@vdom@vnode:element(PHO).
...
-spec fragment(list(lustre@vdom@vnode:element(PHY))) -> lustre@vdom@vnode:element(PHY).
fragment(Children) ->
...
-file("src/lustre/element.gleam", 233).
?DOC(
...
-spec map(lustre@vdom@vnode:element(PIG), fun((PIG) -> PII)) -> lustre@vdom@vnode:element(PII).
map(Element, F) ->
...
-file("src/lustre/element.gleam", 273).
?DOC(
...
-file("src/lustre/element.gleam", 300).
?DOC(
...
-file("src/lustre/element.gleam", 345).
?DOC(
