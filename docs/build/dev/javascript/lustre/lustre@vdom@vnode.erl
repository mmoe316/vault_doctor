...
-export([is_void_html_element/2, to_keyed/2, fragment/4, element/9, text/3, unsafe_inner_html/6, to_snapshot/1, to_string_tree/1, to_string/1, to_json/1]).
...
-type element(OOH) :: {fragment,
        integer(),
        binary(),
        fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
        list(element(OOH)),
        lustre@internals@mutable_map:mutable_map(binary(), element(OOH))} |
    {element,
        integer(),
        binary(),
        fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
        binary(),
        binary(),
        list(lustre@vdom@vattr:attribute(OOH)),
        list(element(OOH)),
        lustre@internals@mutable_map:mutable_map(binary(), element(OOH)),
        boolean(),
        boolean()} |
...
?DOC(false).
-spec to_keyed(binary(), element(OPE)) -> element(OPE).
to_keyed(Key, Node) ->
    case Node of
...
-spec fragment(
    ...
    fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
    list(element(OOI)),
    lustre@internals@mutable_map:mutable_map(binary(), element(OOI))
) -> element(OOI).
...
-spec element(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(OOP)),
    list(element(OOP)),
    lustre@internals@mutable_map:mutable_map(binary(), element(OOP)),
    boolean(),
    boolean()
) -> element(OOP).
element(
...
-spec unsafe_inner_html(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(OPA)),
    binary()
) -> element(OPA).
...
-spec element_to_json(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(OPH)),
    list(element(OPH))
) -> gleam@json:json().
